...
namespace OpenRA.Mods.YR.Widgets
{
    public class VoxelWidget : Widget
    {
        ...
        public override void Draw()
        {
            ...
            Game.Renderer.Flush();
	    Game.Renderer.BeginWorld(new Rectangle(-origin - PreviewOffset, new Size(WorldRenderer.Viewport.Rectangle.Width, WorldRenderer.Viewport.Rectangle.Height)));

            foreach (var r in renderables)
                r.Render(WorldRenderer);
            
            Game.Renderer.Flush();
            Game.Renderer.BeginWorld(WorldRenderer.Viewport.Rectangle);
        }
        ...
        public override void PrepareRenderables()
        {
            ...
            VoxelPreview preview = new VoxelPreview(
            ...
            List<VoxelPreview> previews = new List<VoxelPreview>() {
                preview
            };
            ...
            var rs = previews.SelectMany(p => p.DoScreenBounds(WorldRenderer, WPos.Zero));
            ...
            renderables = previews
                .SelectMany(p => p.DoRender(WorldRenderer, WPos.Zero))
