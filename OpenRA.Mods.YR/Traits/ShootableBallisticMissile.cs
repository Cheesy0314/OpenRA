...
namespace OpenRA.Mods.YR.Traits
{
	...
	public class ShootableBallisticMissileInfo : ITraitInfo, IMoveInfo, IPositionableInfo, IFacingInfo
	{
		...
		*/
		...
		public bool CanEnterCell(World world, Actor self, CPos cell, SubCell subCell = SubCell.FullCell, Actor ignoreActor = null, BlockedByActor checkTransientActors = BlockedByActor.All)
		{
			return false;
		}
		...
		INotifyCreated, INotifyAddedToWorld, INotifyRemovedFromWorld, INotifyActorDisposing, IActorPreviewInitModifier
	{
		...
		public bool CanEnterCell(CPos pos, Actor actor = null, BlockedByActor check = BlockedByActor.All) { return false; }
	...
	public Activity MoveTo(CPos cell, int nearEnough, Actor ignoreActor, bool isClose = false, Primitives.Color? targetLineColor = null)
	{
